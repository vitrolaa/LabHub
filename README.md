...
## Descrição
O **LabHUb** é um sistema que facilita o gerenciamento e monitoramento do hardware disponível, tendo um controle eficiente do inventário e uso dos recursos, com facil entendimento no design.
